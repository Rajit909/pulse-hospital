...
<div className="flex items-center justify-center flex-col gap-y-2 py-5">
      ...
      <p className="text-lg font-medium text-slate-700/ dark:text-slate-100">Most asked questions by patient</p>
    </div>
        <ul className="mx-4 md:max-w-3xl lg:max-w-6xl md:mx-auto divide-y  shadow shadow-blue-200 rounded-xl">
    <li>
        <details className="group">
            <summary className="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer">
                
                <MdArrowRight  size={34} className=" text-gray-500 dark:text-gray-200 transition group-open:rotate-90" />
